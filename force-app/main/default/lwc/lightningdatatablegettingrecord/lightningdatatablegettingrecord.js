...
import fetchContacts from '@salesforce/apex/Lightningdatatablegettingrecord.fetchContacts';
export default class Lightningdatatablegettingrecord extends LightningElement {
   @track searchTerm;
   ...
   handleFilterClick() {
    this.filteredRecords = this.records.filter(record => {
      // Filter the records based on the searchTerm
    });
  }
